...
import style from './privecyandpolicy.module.css'
import AOS from 'aos'
...
export default function PrivacyandPolicy() {
    ...
    return (
        <>
            <Helmet>
                <title>NSP Global Services - Privacy And Policy</title>
                <meta name="description" content="This Privacy Policy covers our policies and processes for collecting, using, and disclosing your information when You use the Service, as well as Your privacy rights and how the law protects You." />
                <link rel="canonical" href="https://www.nspglobalservices.com/privacy-policy" />
            </Helmet>
            ...
            <div className={style.container3}>
                ...
                <ul className={style.container3_ul}>
                    ...
                    <li className={style.container3_li}>
                        <div className={style.container3_li_div}>
                            <img src={check} alt="check" />
                            <span><strong>Service</strong> means a unique account created for You to access our Service or parts of our Service.</span>
                        </div>
                    </li>
                    <li className={style.container3_li}>
                        <div className={style.container3_li_div}>
                            <img src={check} alt="check" />
                            <span><strong>Account</strong>  refers to the Website.</span>
                        </div>
                    </li>
                    <li className={style.container3_li}>
                        <div className={style.container3_li_div}>
                    ...
                    <li className={style.container3_li}>
                        <div className={style.container3_li_div}>
                            <img src={check} alt="check" />
                            <span><strong>Website</strong>  refers to NSP Global Services, accessible from <a href="">https://nspglobalservices.com/</a> </span>
                        </div>
                    </li>
                    <li className={style.container3_li}>
                        <div className={style.container3_li_div}>
            ...
            <div className={style.container4}>
                ...
                <div className={style.container4div1}>
                    <h2>Usage Data</h2>
                ...
                <div>
                    ...
                    <ul className={style.container3_ul}>
                        ...
                        <li className={style.container3_li}>
                            <div className={style.container3_li_div}>
                                <img src={check} alt="check" />
                                <span><strong>To provide You</strong> with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</span>
                            </div>
                        </li>
                        <li className={style.container3_li}>
                            <div className={style.container3_li_div}>
                ...
                <div>
                    ...
                    <ul className={style.container3_ul}>
                        <li className={style.container3_li}>
                            ...
                            <div className={style.container3_li_div}>
                                <img src={check} alt="check" />
                                <span>By visiting this page on our website: <a target='_blank' href="https://nspglobalservices.com/contact-us">https://nspglobalservices.com/contact-us/</a></span>
                            </div>
                        </li>
                    </ul>
                </div>
