...
import style from '../LandingPages/termsandcondition.module.css'
...
export default function TermsandCondition() {
    ...
    return (
        <>
            <Helmet>
                <title>NSP Global Services - Terms And Condition</title>
                <meta name="description" content="Please read these terms and conditions carefully before using Our Service." />
                <link rel="canonical" href="https://www.nspglobalservices.com/terms-condition" />
            </Helmet>
                ...
                <div>
                    ...
                    <ul className={style.container3_ul}>
                        ...
                        <li>
                            <div className={style.container3_li}>
                                <img src={check} alt="check" />
                                <span><strong>Country</strong> refers to: Bihar, India</span>
                            </div>
                        </li>
                        <li>
                            <div className={style.container3_li}>
                                <img src={check} alt="check" />
                                <span><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to NSP Global Services, India.</span>
                            </div>
                        </li>
                        <li>
                            <div className={style.container3_li}>
                        ...
                        <li>
                            <div className={style.container3_li}>
                                <img src={check} alt="check" />
                                <span><strong>Terms and Conditions</strong> (also referred as “Terms”) mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the Free Terms and Conditions Generator.</span>
                            </div>
                        </li>
                        <li>
                            <div className={style.container3_li}>
                        ...
                        <li>
                            <div className={style.container3_li}>
                                <img src={check} alt="check" />
                                <span><strong>Website</strong> refers to NSP Global Services, accessible from <a target='_blank' href="https://nspglobalservices.com/">https://nspglobalservices.com/</a></span>
                            </div>
                        </li>
                        <li>
                            <div className={style.container3_li}>
                ...
                <div>
                    ...
                    <ul className={style.container3_ul}>
                        <li>
                            ...
                            <div className={style.container3_li}>
                                <img src={check} alt="check" />
                                <span>By visiting this page on our website: <a target='_blank' rel='noreferrer' href="https://nspglobalservices.com/contact-us">https://nspglobalservices.com/contact-us/</a></span>
                            </div>
                        </li>
                    </ul>
                </div>
